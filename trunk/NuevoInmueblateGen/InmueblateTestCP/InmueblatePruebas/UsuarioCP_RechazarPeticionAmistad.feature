Feature: UsuarioCP_RechazarPeticionAmistad

@mytag
Scenario: Rechazar_Peticion_Correcta
...
Scenario: Rechazar_Peticion_Incorrecta1
	Given La peticion con id 2 a sido aceptada
	And El emisor es amigo del receptor
...
Scenario: Rechazar_Peticion_Incorrecta2
	Given La peticion con id 2 a sido aceptada
