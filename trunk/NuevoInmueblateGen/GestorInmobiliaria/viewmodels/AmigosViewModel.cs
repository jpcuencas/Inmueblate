...
{
    class AmigosViewModel : ObservableObject, IDataErrorInfo
    {
        ServiceClient service = null;
        IList<UsuarioDTO> usuarios = null;
        UsuarioDTO selectedUsuario;
        UsuarioDTO usuarioAmigos;
        ...
        public AmigosViewModel(UsuarioDTO usuario, string breadcrumb)
        {
            ...
            Usuarios = service.NuevoInmueblate_Usuario_ObtenerAmigos(usuarioAmigos.Id, inicioPaginacion + 1);
            ...
            Usuarios = service.NuevoInmueblate_Usuario_ObtenerAmigos(usuarioAmigos.Id, inicioPaginacion);
