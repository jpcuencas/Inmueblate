...
{
    [Binding]
    public class EntradaCEN_AnyadirUsuariosMeGustaSteps
    {
        ...
        [Given(@"id usuario id: (.*) id: (.*) id: (.*) id: (.*)")]
        public void GivenIdUsuarioIdIdIdId(int p0, int p1, int p2, int p3)
        {
            usuarios.Add(us1);
            usuarios.Add(us2);
            usuarios.Add(us3);
        ...
        [Given(@"ids no existe usuario id: (.*) id: (.*) id: (.*) id: (.*)")]
        public void GivenIdsNoExisteUsuarioIdIdIdId(int p0, int p1, int p2, int p3)
        {
            usuarios.Add(us1);
            usuarios.Add(us2);
            usuarios.Add(78);
        ...
        [Given(@"id usuario id: (.*) id: null id: (.*) id: (.*)")]
        public void GivenIdUsuarioIdIdNullIdId(int p0, int p1, int p2)
        {
            usuarios.Add(us1);
            usuarios.Add(us2);
            usuarios.Add(0);
        ...
        public void WhenAnadeUsuariosMeGusta()
        {
            entrCEN.AnyadirUsuariosMeGusta(entrid, usuarios);
        }
        
        [Then(@"guarda correctamente")]
        public void ThenGuardaCorrectamente()
        {
