(function (h) {
    h.fn.passStrengthify = function (a) {
        var q = h(this), m, r = [[0, 8, 16, 32, 48, 64, 72], [0, 16, 32, 48, 64, 78, 92], [0, 32, 64, 78, 92, 108, 128]], s = ["Muy poco fiable", "Muy poco fiable", "Poco fiable", "Poco fiable", "Aceptable", "Buena", "Robusta", "Muy robusta"], n = ["gray", "red", "red", "#C00000", "orange", "#0099FF", "blue", "green"], i = r[0], u = h("<span>").css("margin-left", "1em"), t = [], e = 0, v = 0, w = false, B = function (b) {
            var c = 0, d = { "[a-z]": 26, "[A-Z]": 26, "(\\d[^\\d])|(^\\d+$)": 10, "[\\W_]": 32 }; b = b.replace(/(.)(\1)(\1)+/gi, "$1$2"); b = b.replace(/(a)(b(c(d(e(f(g(h(i(j(k(l(m(n(o(p(q(r(u(v(w(x(y(z)?)?)?)?)?)?)?)?)?)?)?)?)?)?)?)?)?)?)?)?)?)?)?/gi,
